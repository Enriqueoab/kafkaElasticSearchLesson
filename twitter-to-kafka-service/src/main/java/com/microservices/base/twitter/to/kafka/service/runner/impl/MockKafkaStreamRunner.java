...
@Component
// TODO: Conditionally create a Spring bean with a config variable. If enable-mock-tweets:true this class will be
//       load at run time and "TwitterKafkaStreamRunnerImp" ignored. This way, we decide the implementation class
//       at compile time by just setting a configuration variable
//       and Spring will load the correct bean at runtime.
@ConditionalOnProperty(name = "twitter-to-kafka-service.enable-mock-tweets", havingValue = "true")
public class MockKafkaStreamRunner implements TwitterKafkaStreamRunner {
    ...
    private void simulateTwitterStream(String[] keywords, int minTweetLength, int maxTweetLength, long sleepTimeMs) {
        // TODO: To run the code in a new thread. Submit methods take a functional interface, either Runnable or Callable.
        // Empty parenthesis as there is no input () -> {
